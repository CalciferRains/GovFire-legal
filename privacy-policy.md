...
GovFIRE does not collect, transmit, or store any personal information on external servers. Specifically:
...
The financial figures you enter into GovFIRE (such as years of service, retirement age, account balances, and disability rating) are stored locally on your device using encrypted storage. This data never leaves your device. It is not backed up to cloud services and is not accessible to other apps.

You can delete all stored data at any time using the "Reset & start over" option in the app's Assumptions screen. Uninstalling the app also removes all stored data.
...
GovFIRE is not directed at children under the age of 13 and does not knowingly collect information from children.

## Security

All financial data entered into the app is stored using Android Keystore-backed encryption (AES-GCM) via Expo SecureStore. Data is encrypted at rest on your device and is excluded from device backups.
